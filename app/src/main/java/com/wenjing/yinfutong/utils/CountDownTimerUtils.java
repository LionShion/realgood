...
/**
 * Created by wenjing on 2017/10/9.
 */
...
//        mTextView.setBackgroundResource(R.color.colorInputHintGray); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setTextColor(AppContext.instance().getResources().getColor(R.color.colorPrimary));
    }
}
