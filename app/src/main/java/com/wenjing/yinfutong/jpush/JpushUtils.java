...
public class JpushUtils {
    ...
    public static void setMyJpushAlias(Customer customer) {
        String alias = String.valueOf(customer.getAccountId());
        if(isValidTagAndAlias(alias)){
            ...
            TagAliasOperatorHelper.getInstance().handleAction(AppContext.instance() , TagAliasOperatorHelper.sequence , bean);
            TLog.log(TAG , "setJpushAlias : " + true);
        }
    }


    public static void deleteMyJpushAlias(Customer customer) {
        String alias = String.valueOf(customer.getAccountId());
        if(isValidTagAndAlias(alias)){
            TagAliasOperatorHelper.TagAliasBean bean = new TagAliasOperatorHelper.TagAliasBean();
            ...
            TagAliasOperatorHelper.getInstance().handleAction(AppContext.instance() , TagAliasOperatorHelper.sequence , bean);
            TLog.log(TAG , "deleteMyJpushAlias : " + true);
        }
    }
}
